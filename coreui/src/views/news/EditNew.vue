...
export default {
  ...
  methods: {
    ...
    update() {
        ...
        axios.post(  this.$apiAdress + '/api/news/update?token=' + localStorage.getItem("api_token"),
          {
        ...
        .then(function (response) {
          if (response.data.status == 'error') {
            ...
            self.message = 'Successfully updated New.';
            self.showAlert();
            self.errors = [];
          }
  ...
  mounted: function(){
    let self = this;
    axios.get(  this.$apiAdress + '/api/news/edit?token=' + localStorage.getItem("api_token") + '&id=' + self.$route.params.id )
    .then(function (response) {
        self.title         = response.data.title;
        self.header        = response.data.header;
        self.body          = response.data.body;
        self.footer        = response.data.footer;
        self.category_id   = response.data.category_id;
        self.category_name = response.data.category_name;
