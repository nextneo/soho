      ...
      <CCard no-header>
        <CCardBody>
          <CForm>
            ...
            <CInput type="text" label="Floor" placeholder="Floor" v-model="floor"></CInput>
            <CInput type="text" label="Acreage" placeholder="Acreage" v-model="acreage"></CInput>
            <CInput type="text" label="TotalBedroom" placeholder="TotalBedroom" v-model="total_bedroom"></CInput>
            <CInput type="text" label="TotalToilet" placeholder="TotalToilet" v-model="total_toilet"></CInput>
            <CInput type="text" label="RoomView" placeholder="RoomView" v-model="room_view"></CInput>
            <CInput type="text" label="SellingPrice" placeholder="SellingPrice" v-model="selling_price"></CInput>
            <CInput type="text" label="RentalPrice" placeholder="RentalPrice" v-model="rental_price"></CInput>
